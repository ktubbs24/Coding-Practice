...
## 🧪 Write a program that will output T or F
...
if user !== 1 OR user !== 0:  #use AND instead of OR because you want both conditions to be true. Do not use !== because Python uses != and JS uses !==
